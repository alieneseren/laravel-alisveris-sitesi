...
<?php $__env->startSection('title', 'Teslimat Bilgileri - Stripe Ödeme'); ?>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                                <div>
                                    <h6 class="mb-1"><?php echo e($item['urun']->ad); ?></h6>
                                    <small class="text-muted">
                                        <?php echo e($item['miktar']); ?> adet × <?php echo e(number_format($item['urun']->fiyat, 2)); ?> ₺
                                    </small>
                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center pt-3">
                                ...
                                <h4 class="mb-0 text-success"><?php echo e(number_format($toplam, 2)); ?> ₺</h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-7">
                    <div class="card shadow-lg border-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="address-form" action="<?php echo e(route('stripe.address.save')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="ad_soyad" name="ad_soyad" 
                                               value="<?php echo e(old('ad_soyad', (auth()->user()->ad ?? '') . ' ' . (auth()->user()->soyad ?? ''))); ?>" required>
                                        <?php $__errorArgs = ['ad_soyad'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="tel" class="form-control form-control-lg" id="telefon" name="telefon" 
                                               value="<?php echo e(old('telefon')); ?>" required placeholder="0555 123 45 67">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control" id="adres" name="adres" rows="3" required 
                                                  placeholder="Mahalle, sokak, bina numarası ve diğer adres detayları"><?php echo e(old('adres')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="il" name="il" 
                                               value="<?php echo e(old('il')); ?>" required placeholder="İstanbul">
                                        <?php $__errorArgs = ['il'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ilce" name="ilce" 
                                               value="<?php echo e(old('ilce')); ?>" required placeholder="Kadıköy">
                                        <?php $__errorArgs = ['ilce'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="posta_kodu" name="posta_kodu" 
                                               value="<?php echo e(old('posta_kodu')); ?>" placeholder="34000">
                                        <?php $__errorArgs = ['posta_kodu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="aciklama" name="aciklama" 
                                               value="<?php echo e(old('aciklama')); ?>" placeholder="Örn: Ev, İş, Kapıcıya teslim edilebilir">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    ...
                                    <a href="<?php echo e(route('sepet.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Enes\Desktop\kafama göre projeler\laravel-php-pazaryeri\resources\views/stripe/address.blade.php ENDPATH**/ ?>